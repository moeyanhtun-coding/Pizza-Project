...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/css/accountdetail.css') }}">
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                ...
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('change#passwordPage') }}">
                                                        <i class="fa-solid fa-lock"></i></i>Change Password</a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__footer p-3">
                                                ...
                                                <form action="{{ route('logout') }}" method="post">
                                                    @csrf
                                                    <input class=" btn btn-dark w-100 font-weight-bolder"

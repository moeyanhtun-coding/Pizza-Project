                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block me-5">
                            <div class="dropdown">
                                <a class="btn btn-primary rounded dropdown-toggle" href="#" role="button"
                                ...
                                <div style="width: 200px" class="dropdown-menu p-3">

                                    <div class="d-flex align-items-center mb-3">
                                        <a href="{{ route('account#detail', Auth::user()->id) }}"
                                            class=" text-decoration-none text-dark">
                                            <i class=" me-3 fa-solid fa-user"></i>{{ Auth::user()->name }}</a>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                        <a href="{{ route('passwordChange#page') }}"
                                            class=" text-decoration-none text-dark">
                                            <i class=" me-3 fa-solid fa-key"></i>Password Change</a>
                                    </div>
                                    <div class="">
                                        <form action="{{ route('logout') }}"method="post"> @csrf
                                            <form action="{{ route('logout') }}" method="post">
                                                @csrf
                                                <input class=" btn btn-dark w-100 font-weight-bolder" type="submit"
                                                    value="Logout">
                                            </form>
                                        </form>
                                    </div>
